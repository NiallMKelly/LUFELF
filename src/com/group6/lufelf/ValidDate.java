...
/**
 * 
 * This class checks if the date is a valid date.
 * 
...
public class ValidDate {
	...
	/**
	 * 
	 * This method checks if the date is valid using Regular Expression
	 * Checking.
	 * 
	 * @param date
	 *            - The string you wish to check if it is a valid date.
